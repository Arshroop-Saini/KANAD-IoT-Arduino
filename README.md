# KANAD -IoT-Arduino 🤖
#### A simple ML and DL based web application which recommends the best crop to grow, fertilizers to use and the diseases caught by your crops.
...
#### Deployment is done using [deploy](https://github.com/Arshroop-Singh/AgroTech-KANAD/tree/deploy) branch
#### This website is deployed at [Heroku](https://www.render.com/)
#### You can access it [here](https://kanad3jzx.onrender.com/)
...
## License 📝
This project is licensed under [GNU (GENERAL PUBLIC LICENSE)](https://github.com/Arshroop-Singh/AgroTech-KANAD/blob/master/LICENSE).

## Contact 📞

#### If you have any doubt or want to contribute feel free to email me or hit me up on [LinkedIn](https://www.linkedin.com/in/arshroop-saini-a376a21b9/)
